...
public class EditTaskDialogFragment extends DialogFragment {
    public static EditTaskDialogFragment newInstance (ModelTask task){
       ...
       if (task.getDate()==null){
           args.putLong("date",0);}
           else{ args.putLong("date", task.getDate());}
    ...
    private EditingTaskListner editingTaskListner;

    public interface EditingTaskListner{
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            editingTaskListner= (EditingTaskListner) activity;
        }catch (ClassCastException e){
            throw new ClassCastException(activity.toString()+" must implement EditTaskListner");
        }
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.editing_dialog_title);
        ...
        builder.setPositiveButton(R.string.dialog_OK, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                editingTaskListner.onTaskEdited(task);
                dialog.dismiss();
